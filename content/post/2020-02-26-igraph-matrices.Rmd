...
g3_weighted <- graph_from_adjacency_matrix(m3_list[[2]], mode = "undirected", weighted = TRUE)
plot(g3_weighted, main="before setup edge width")

E(g3_weighted)$width  <- edge.attributes(g3_weighted)$weight*5
plot(g3_weighted, main="after setup edge width to weight")
